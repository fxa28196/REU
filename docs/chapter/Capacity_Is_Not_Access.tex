...
shows the gap is a knife-edge phenomenon of capacity equal to demand: at 20\%
surplus, admissions reach 99.5\% and the gap vanishes. Compared against the one
...
at the same 36 sites shows that at $1.2\times$ demand --- 1,368 spaces of
surplus --- admissions reach 99.5\% and the failure mode disappears
(Sect.~\ref{sec:equity}).
...
where capacity approximately equals demand: at $1.2\times$ demand, admissions
reach 99.5\% (above C's 96.0\%) and the gap vanishes entirely. We predicted the
crossing would require $1.4$--$1.6\times$ and that the gap would persist under
surplus; both predictions were wrong, and the honest conclusion is stronger ---
surplus dissolves the failure mode, and the triage reserve matters exactly when
surplus cannot be bought.
...
overturned this study's own registered predictions: at 20\% surplus over
demand, admissions reach 99.5\% and the mobility gap vanishes entirely, so the
gap is a phenomenon of the scarcity band where capacity approximately equals
demand. The policy sentence that survives every control is: buy surplus if you

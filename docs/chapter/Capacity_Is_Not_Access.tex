...
\institute{Fatima Asghar \at Harrisburg Area Community College, Harrisburg, PA, \email{fxa28196@hawkmail.hacc.edu}}
\maketitle
...
September 2020 event. Four siting and intake scenarios were compared across nine
random seeds. The present 36-facility system shelters 30.1\% of residents.
...
many residents, reduces total modeled exposure by 93.8\%, and mean distance
walked by 68\%.
...
C's sheltered count exactly, in every seed. The headcount gain over B is
...
spaces) already matches C's admissions --- without closing the gap (14.9 pp)

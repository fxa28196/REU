# Run analysis — `sim-20260725-220449-seed42`

## Reproducibility

| Field | Value |
|---|---|
| Simulation ID | `sim-20260725-220449-seed42` |
| Random seed | `42` |
| Model git commit | `83d721b7e796a803ae86e8942531b7f7e03db038` |
| Data version tag | `0bc943324ae6` |
| Run generated (UTC) | 2026-07-25T22:04:54.647759600 |
| Parameters | `{"numAgents": 2037, "minutesPerTick": 1.0, "walkingSpeedMps": 1.3, "shelterArrivalDistanceM": 200.0, "simulationHours": 312, "randomSeed": 42}` |
| Analysis script | `scripts/analyze_run.py` v1.1.0 |
| Analysis git commit | `83d721b7e796a803ae86e8942531b7f7e03db038` |
| Analysis generated (UTC) | 2026-07-26T02:05:06Z |
...
| Failed arrivals | 1839 {'REFUSED_ALL_FULL': 1824, 'UNREACHABLE': 15} |
| Travel time (arrived) | mean 22 min · median 15 min · max 46 min (0.8 h) |
| Travel distance (arrived) | mean 1.7 km · median 1.2 km · max 3.6 km |
...
| Person-hours above Unhealthy (55.5 µg/m³) | 356841 total · mean 175.2 h/agent |
| Mean dose split | 48616 waiting pre-evac + 155 traveling/stranded |
| Capacity refusals | 1824 agents refused ≥1× (0 later sheltered) · 2344 door refusals total · max 2 per agent |

## Shelter statistics

| Shelter | Operating | Capacity | Final occ. | Unused | Refused | First arrival | Last arrival |
|---|---|---|---|---|---|---|---|
| Charles Jordan Community Center (CJ) | yes | 99 | 99 | 0 | 622 | 2020-09-07T16:03 | 2020-09-07T16:46 |
| Oregon Convention Center (OCC) | yes | 99 | 99 | 0 | 1722 | 2020-09-07T16:03 | 2020-09-07T16:16 |
...
| Agent | State | Shelter | Dose (µg·m⁻³·h) | Travel (min) | h > Unhealthy |
|---|---|---|---|---|---|
| Site 1963 | SHELTERED | OCC | 151 | 3.0 | 0.1 |
| Site 2018 | SHELTERED | CJ | 151 | 3.0 | 0.1 |
| Site 1445 | SHELTERED | CJ | 152 | 4.0 | 0.1 |
| Site 1983 | SHELTERED | OCC | 154 | 5.0 | 0.1 |
| Site 877 | SHELTERED | OCC | 155 | 6.0 | 0.1 |

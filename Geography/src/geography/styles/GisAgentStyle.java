...
/**
 * 3D display style for {@link GisAgent} residents: a flat yellow circle mark.
 *
 * The stock demo varied appearance by the agent's water state; that state was
 * removed with the demo water logic (it was never set in this model, so the
 * rendered appearance is unchanged). Future work may style residents by
 * vulnerability or exposure state instead.
 *
 * @author Eric Tatara
 */

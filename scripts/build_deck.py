...
minute), <code>routing/StreetNetwork.java</code> (graph + shortest paths).</div></section>
...
<p>27 intersection IDs appeared at physical locations 9–18.5 km apart, welding distant places
into one node and creating <b>50 impossible edges</b>. Found because one person walked a
reported 68.3 km; proved by an independent Python re-implementation of the routing.</p>
<p><b>Fix:</b> cluster claims by geometry, reattach within 10 m (4 cases) or split to a new
...
graph and re-runs Dijkstra in Python — five tests, exact agreement on distance.</div></section>
